...
const CommentData  = [
    ...
    {
        name:"chow",
        comment:"intersing to learn react in deep ",
        replies:[]
...
return comments.map((comment,index) =>(
    <div>
        ...
        <div className='pl-5 border border-l-white ml-5 bg-red-100'>
...
const Comments = () => {
  return (
    <div className='m-4 p-2 '>
        <h1 className='text-2xl font-bold'>commenets</h1>
